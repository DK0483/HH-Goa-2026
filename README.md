...
A personalized **HH Goa 2026 Builder Card Generator** built with **Python, Flask and Pillow**.
...
Upload your profile photo through the builder interface.
...
- **RAGHAV KHARE** — X: [@Squalorider12](https://x.com/Squalorider12)
